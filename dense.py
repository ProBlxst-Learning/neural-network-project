...
=======
>>>>>>> 8cd16f11b35259b3443db29d98848487813f6c7a
...
<<<<<<< HEAD
            ...
            matplotlib.pyplot.plot(
                history[i].history['loss'], color='blue', label='train')
            matplotlib.pyplot.plot(
                history[i].history['val_loss'], color='orange', label='test')
            # plot accuracy
            matplotlib.pyplot.subplot(2, 1, 2)
            matplotlib.pyplot.title('Classification Accuracy')
            matplotlib.pyplot.plot(
                history[i].history['accuracy'], color='blue', label='train')
            matplotlib.pyplot.plot(
                history[i].history['val_accuracy'], color='orange', label='test')
